...
try{
  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center h-screen bg-cover  bg-[url(https://tse3.mm.bing.net/th/id/OIP.hUaCDuWAqM2zqcHr0RpNqgHaE8?pid=Api&P=0&h=180)]">
