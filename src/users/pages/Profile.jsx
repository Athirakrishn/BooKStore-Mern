          ...
          <div  className="p-10 my-20 mx-5 bg-gray-200">
            ...
            <div className="md:grid grid-cols-2 mt-10 w-full">
              ...
              <div className="px-3">
                ...
                <div className="mb-3">
                  <input value={bookDetails.languages} onChange={e=>setBookDetails({...bookDetails,languages:e.target.value})} type="text" placeholder='languages' className="w-full p-2  rounded placeholder-gray-400 text-black bg-white" />
                </div>
                 <div className="mb-3">
...
//   const [purchaseStatus, setPurchaseStatus] = useState(false)
//   const [bookDetails, setBookDetails] = useState({
//     title: "", author: "", noOfPages: "", imageUrl: "", price: "", discountPrice: "", abstract: "", publisher: "", languagess: "", isbn: "", category: "", uploadImages: []
//   })
//   console.log(bookDetails);
//   const [preview, setPreview] = useState("")
//   const [previewList, setPreviewList] = useState([])
...
//                   <div className="mb-3 px-3">
//                     <input value={bookDetails.languagess} onChange={e => setBookDetails({ ...bookDetails, languagess: e.target.value })} type="text" placeholder='languages' className='w-full p-2  rounded placeholder-gray-400 text-black bg-white' />
//                   </div>
